...
##############################################################
	*	This module adds a button in Sales Order screen "Create Draft Purchase Order" which creates a new Purchase order in RFQ state with all sale order line items.
